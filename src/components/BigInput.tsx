...
"
     ...
     <h3 className="text-[#458BD1] text-[20px]">Кол-во комнат: </h3>
      <div className="flex gap-[10px] list-none my-[15px] mr-[91px]">
        <li className="bg-[#FFDF42] rounded-md w-[30px] text-center py-[4px] text-[#211A1D]">1</li>
        <li className="border-[#FFDF42] border w-[30px] text-center py-[4px] rounded-md text-[#211A1D]">2</li>
        <li className="border-[#FFDF42] border w-[30px] text-center py-[4px] rounded-md text-[#211A1D]">3</li>
        <li className="border-[#FFDF42] border w-[30px] text-center py-[4px] rounded-md text-[#211A1D]">4+</li>
      </div>
     </div>
     <button className="w-[230px] py-[18px] text-center bg-[#FFDF42] rounded-[60px] text-black">ПОИСК</button>
    </div>
  );
}
